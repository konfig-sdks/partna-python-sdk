...
from partna_python_sdk.model.transaction_get_details_response import TransactionGetDetailsResponse as TransactionGetDetailsResponseSchema

from partna_python_sdk.type.transaction_get_details_response import TransactionGetDetailsResponse

from ...api_client import Dictionary
from partna_python_sdk.pydantic.transaction_get_details_response import TransactionGetDetailsResponse as TransactionGetDetailsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TransactionGetDetailsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TransactionGetDetailsResponse
    ...
    async def _aget_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/transaction/{transactionId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TransactionGetDetailsResponsePydantic:
        raw_response = await self.raw.aget_details(
            transaction_id=transaction_id,
            **kwargs,
        )
        if validate:
            return TransactionGetDetailsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TransactionGetDetailsResponsePydantic, raw_response.body)
